...
| <span id="p-06"></span>P-06 | **Observabilidade Nativa** | Logs estruturados, métricas e rastreamento distribuído são requisitos, não opcionais | [NFR-04](requisitos.md#nfr-04), [D-04](drivers.md#d-04) | Instrumentação desde o início; SLOs definidos antes do go-live |
...
| <span id="p-08"></span>P-08 | **Segurança por Design** | Autenticação, autorização e proteção de dados são considerados desde a concepção | [NFR-05](requisitos.md#nfr-05) | Zero trust entre serviços; mTLS ou JWT para comunicação interna |
