...
| <span id="d-05"></span>D-05 | Lançamentos financeiros não podem ser perdidos mesmo em cenários de falha parcial do sistema | Operação | Confiabilidade | [NFR-03](requisitos.md#nfr-03), [RF-06](requisitos.md#rf-06) | A definir — garantia de entrega | Mensageria + persistência |
