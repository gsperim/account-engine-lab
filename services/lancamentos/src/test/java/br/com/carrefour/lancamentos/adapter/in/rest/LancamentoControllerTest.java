...
@Import({LancamentoMapper.class, GlobalExceptionHandler.class})
class LancamentoControllerTest {
    ...
    void buscar_deveRetornar200QuandoEncontrado() throws Exception {
        ...
        mvc.perform(get("/lancamentos/{id}", ID))
    ...
    void listar_deveRetornarPaginaComLancamentos() throws Exception {
        ...
        mvc.perform(get("/lancamentos").param("data", "2026-05-09"))
            .andExpect(status().isOk())
