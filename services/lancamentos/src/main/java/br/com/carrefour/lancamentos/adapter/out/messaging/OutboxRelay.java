...
public class OutboxRelay {
    ...
    public OutboxRelay(OutboxJpaRepository outboxRepo, RabbitTemplate rabbitTemplate, ObjectMapper mapper) {
    ...
    public void processar() {
        ...
        for (var entry : pendentes) {
            try {
                publicar(entry.getPayload(), entry.getLancamentoId());
    ...
    void publicar(String payload, java.util.UUID lancamentoId) throws Exception {
